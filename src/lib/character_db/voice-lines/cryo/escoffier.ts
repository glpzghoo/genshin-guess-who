export const escoffierVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: '1006',
      text: "Well met. I am Escoffier, Patissiere Supreme and master of precision gastronomy. As an esteemed guest of the divine, you deserve the finest cuisine Teyvat has to offer. I hope my work is to your satisfaction.\\nIf you have an interest in the culinary arts, allow me to introduce you to the wonderful world of haute cuisine. I just hope you're mentally prepared for the undertaking. I don't tolerate a quitter.",
      tips: '',
      tasks: null,
    },
    '1': {
