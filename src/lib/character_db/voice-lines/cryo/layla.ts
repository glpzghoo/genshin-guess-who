export const laylaVL = {
  quotes: {
    ...
    '43': {
      ...
      audio: '8004',
      text: "Get it together, Layla! Believe in yourself, and in the person who's helped you come this far. The two of you together can solve any problem that comes your way!\\nWhew... Alright! Time to leave my worries behind. Let's go!",
