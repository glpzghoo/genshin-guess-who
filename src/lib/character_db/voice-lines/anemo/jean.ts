export const jeanVl = {
  quotes: {
    ...
    '37': {
      ...
      audio: '5004',
      text: 'When I\'m wholeheartedly devoted to my work, all of my troubles and even my sense of time seem to just slip away. Hmm, Grand Master Varka did say to me: "Jean, there is no better candidate for this task"...',
