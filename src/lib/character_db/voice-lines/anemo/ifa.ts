export const ifaVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: '1006',
      text: "<color=#37FFFF>Ifa:</color> Hey there. I'm Ifa, a sauro-vet from the Flower-Feather Clan. You've probably heard some things about me already, but it's all good. Whatever impression you have of me, I say let's wipe the slate clean and just get to know each other.\\n<color=#37FFFF>Ifa:</color> Oh yeah, then there's this little dude... that's Cacucu, my assistant. A... \"sauro-vet\" in a different sense of the word, I guess. I hope the two of you will get along.\\n<color=#37FFFF>Cacucu:</color> Nice to meet you, bro!",
      tips: '',
      tasks: null,
    },
    '1': {
    ...
    '28': {
      ...
      audio: '5001',
      text: "<color=#37FFFF>Ifa:</color> That painting on the board outside my clinic — wasn't me, I swear.\\n<color=#37FFFF>Cacucu:</color> Hahahaha!",
      tips: '',
      tasks: null,
    },
    '29': {
    ...
    '34': {
      ...
      audio: '6012',
      text: '<color=#37FFFF>Ifa:</color> I think I have it pretty good, to be honest. Nothing keeping me up at night. ...Oh, but it would be nice if Cacucu learned some more useful phrases.\\n<color=#37FFFF>Cacucu:</color> The heck are you on about?',
      tips: '',
      tasks: null,
    },
    '35': {
    ...
    '44': {
      ...
      audio: '8004',
      text: "<color=#37FFFF>Ifa:</color> Thanks, bro! If you ever need a hand with anything, don't be shy — hit me up anytime!\\n<color=#37FFFF>Cacucu:</color> Hit me up, bro!",
    ...
    '47': {
      ...
      audio: '100003',
      text: '<color=#37FFFF>Cacucu:</color> Up and away!',
      tips: '',
      tasks: null,
    },
    '48': {
      ...
      audio: '100004',
      text: '<color=#37FFFF>Cacucu:</color> Oh dear! Oh dear!\\n<color=#37FFFF>Ifa:</color> Come on, buddy!',
      tips: '',
      tasks: null,
    },
    '49': {
    ...
    '57': {
      title: 'Low HP: III',
      audio: '410003',
      text: '<color=#37FFFF>Cacucu:</color> Ifa? Ifa!\\n<color=#37FFFF>Ifa:</color> I know, I know...',
      tips: '',
      tasks: null,
    },
    '58': {
