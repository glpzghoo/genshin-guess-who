export const neuvilletteVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: '1006',
      text: 'Greetings. I am the Chief Justice, or "Iudex" of Fontaine, but you may simply address me by using my surname, "Neuvillette." Not because I wish to keep my distance from you... No, I am merely conscious that being overly familiar may bring the impartiality of the judiciary into question in some people\'s eyes.\\nIf you have any requests or concerns, then — to the extent permissible by law, at least — we can sit down and discuss them together as we partake of some imported water from Qiaoying Village.',
      tips: '',
      tasks: null,
    },
    '1': {
