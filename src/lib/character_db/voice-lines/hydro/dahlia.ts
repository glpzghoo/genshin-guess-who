export const dahliaVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: '1006',
      text: "Greetings, I'm Dahlia, Deacon of the Church of Favonius and Herald of Barbatos. As you can probably tell, I'm going out of my mind with boredom right now. So, what's going on in your life? Any issues you're facing? I'm hear to listen. And probably to laugh, a little... But also to help.",
      tips: '',
      tasks: null,
    },
    '1': {
    ...
    '12': {
      title: 'About Dahlia: Divine Favor',
      audio: '2005',
