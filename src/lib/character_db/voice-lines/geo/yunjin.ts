export const yunjinVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: '1000',
      text: "As the saying goes, you never truly know someone until you meet them in person, and at long last, I finally have the great honor of meeting you today. My name is Yun Jin, and I am humbled to be the director of the Yun-Han Opera Troupe. We have been performing at Heyu Tea House as of late, and we'd be honored to have you attend a performance sometime.",
      tips: '',
      tasks: null,
    },
    '1': {
    ...
    '57': {
      title: 'Low HP: III',
      audio: '410003',
      text: 'This script needs a rewrite...',
      tips: '',
      tasks: null,
    },
    '58': {
