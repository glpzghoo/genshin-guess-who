export const neuvilletteVL = {
  quotes: {
    ...
    '15': {
      title: 'About ___: The Weeping Hydro Dragon',
      audio: '2005',
    ...
    '23': {
      ...
      audio: '3003',
      text: "The Vishaps' ancestry can be traced directly back to the Fontemer Sea, which is why they are so adept at evolution. I am reminded of an old custom that the dragons once observed: We would take a sip of our perished young brethren's blood. Whenever the tides are disrupted by the motion of the moon and stars, the water within the bodies of us Hydro organisms surges up towards our heads, reminding us that our deceased kin will soon be revived.",
      tips: 'Complete "Cataclysm\'s Quickening."',
      tasks: [
        {
          type: 'finishMainQuest',
