export const xianyunVL = {
  ...
  story: {
    ...
    '7': {
      title: 'Vision',
      title2: null,
      text: "The adepti of Liyue were born amongst the elemental energy that courses between heaven and earth. As pure elemental beings, they are closer to the origin of ultimate truth than ordinary mortals.\\nFor ___, channeling elemental power is something that can be done almost subconsciously. She requires the aid of no external focus to do so, let alone a Vision.\\nBut now that she's walking the mortal realm in human form, following human rules somehow seems oddly appropriate. To her, using a Vision as a medium to harness elemental power couldn't be easier... so why not?\\n___ certainly does not value the Vision that she wears on her arm in the same way that a mortal would. But carrying it with her led to a discovery.\\nOne time, as she was passing through Dihua Marsh, she came upon a farmer. Despite the fact that he was tall and carried a hoe, he was trembling and immobilized with fear in the face of a pair of short, feeble-looking bandits who were threatening him with daggers. Intending to help, ___ stepped forward — but seeing that she was a woman and slightly-built to boot, he tried to persuade her to stay out of it so she wouldn't get hurt.\\nBut when ___ turned to speak to him, he saw her Vision and immediately took her for a chivalrous hero instead. His tone and posture changed in the blink of an eye, and after bidding her join him in driving off the bandits, he charged straight at them. In the end, the hoe-brandishing farmer singlehandedly repelled the two thieves, with ___ merely knocking a dagger out of one of their hands. Yet looking at the shining Vision on her arm, the farmer kept exclaiming how much he wished he had one.\\nOf course, the farmer didn't need a Vision — all he really needed was a little courage. But she saw the effect that the Vision had on him, and how his expression changed so completely it was almost as if he had become another person. The profound influence that an external object could exert upon a person became apparent in that instant.\\nFor a time, this left her feeling puzzled.\\nThough it may be true that everything in this world possesses its own objective characteristics, but changing how you act towards a person because of an external object... surely that was folly in almost all cases. Known for her candor, she has always been easily moved to commend or scorn, but her judgment was always based on essence rather than appearance.\\nWhen people are friendly to her, she treats them kindly back; but when they're vile, all she has for them is her contempt. This is how she is when she's Cloud Retainer, so it's how she'll be as the chivalrous hero ___ too.\\n\"Open your eyes and take a look around — I didn't lift a finger. Since you can rely on your own skill to drive away your enemies, you should show some more confidence.\" ___ had said her piece, so with a flick of her sleeve, she was off.\\nWith heroism she cleanses the world below, and with wisdom imparts the laws of nature. To this day ___ walks the mortal realm still, poised and unaffected.",
      text2: null,
      tips: 'Unlocks at Friendship Lv. 6',
    },
  },
