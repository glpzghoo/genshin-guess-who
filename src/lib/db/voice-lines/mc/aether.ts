export const aetherVL = {
  quotes: {
    ...
    '174': {
      ...
      audio: 'VO_Aether_About_the_Mysterious_Treasure_of_the_Fontaine_Research_Institute',
    ...
    '199': {
      ...
      audio: 'VO_Aether_About_the_Collective_of_Plenty_and_the_Flower-Feather_Clan',
