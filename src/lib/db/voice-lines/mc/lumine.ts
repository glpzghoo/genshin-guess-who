export const lumineVL = {
  quotes: {
    ...
    '4': {
      ...
      audio: 'VO_Lumine_About_Effort_and_Reward',
    ...
    '11': {
      ...
      audio: 'VO_Lumine_About_Couplets',
    ...
    '23': {
      ...
      audio: 'VO_Lumine_About_Being_Sisters',
      text: "#___: Lisa and Amber feel a bit like sisters.\\n___: Huh? Why's that?\\n___: Amber often runs errands for Lisa. Older siblings asking their younger siblings to do things for them so they can slack off is a rather common practice...\\n___: But, my brother and I are the same age, so we had to decide these things via rock-paper-scissors.\\n___: Whoa. So, doesn't that make you my younger sister?\\n___: What do you mean?\\n___: Well, since ___ floats, you're the only one who can \"run\" any errands!\\n___: ...Seriously?",
      tips: 'Complete "The Outlander Who Caught the Wind"',
      tasks: [
        {
          type: 'finishSubQuest',
    ...
    '25': {
      ...
      audio: 'VO_Lumine_About_Kaeya_and_Diluc',
    ...
    '29': {
      ...
      audio: 'VO_Lumine_About_the_Wondermaid',
    ...
    '35': {
      title: 'About Flying',
      audio: 'VO_Lumine_About_Flying',
      text: "#___: Come on, ___, ___'ll teach you how to fly!\\n___: Three, two, one!\\n___: Ah, ___'s gone.\\n___: Well, whatever. *sigh* I'm tired. Let's just... sit here for a bit.\\n___: *yawn* I'm flying with you... in my heart... Mm...",
      tips: 'Complete "The Outlander Who Caught the Wind"',
      tasks: [
        {
          type: 'finishSubQuest',
    ...
    '37': {
      ...
      audio: 'VO_Lumine_About_Hilichurls',
    ...
    '42': {
      ...
      audio: 'VO_Lumine_About_Weight_Gain',
    ...
    '43': {
      ...
      audio: 'VO_Lumine_About_Cat_People_and_Dog_People',
    ...
    '50': {
      ...
      audio: 'VO_Lumine_About_Nightmares',
      text: "#___: Have you ever had one of those super scary nightmares, ___?\\n___: Um, I've dreamt of falling through endless darkness...\\n___: Without a wind glider.\\n___: Eek...\\n___: I've also dreamt of my brother walking away from me, while I'm unable to catch up to him no matter how fast I run.\\n___: ...He tells me that I've \"come too late.\"\\n___: Oh...\\n___: Yours are quite different from the ones that ___'s had.\\n___: ___'s scariest dream was being eaten by a super giant slime.",
      tips: 'Complete "For a Tomorrow Without Tears"',
      tasks: [
        {
          type: 'finishSubQuest',
    ...
    '52': {
      ...
      audio: 'VO_Lumine_About_Someone_Unforgettable',
      text: "#___: Has anyone left a big impression on you during our recent travels?\\n___: For ___, that's Sara.\\n___: Timmie.\\n___: ...Huh? Why him?\\n___: *sigh* His face comes to mind every time I've eaten a Sweet Madame recently... Really makes it hard to chow down.",
      tips: 'Complete "The Outlander Who Caught the Wind"',
      tasks: [
        {
          type: 'finishSubQuest',
    ...
    '53': {
      ...
      audio: 'VO_Lumine_About_Language',
    ...
    '55': {
      ...
      audio: 'VO_Lumine_About_Storing_Weapons',
    ...
    '58': {
      ...
      audio: 'VO_Lumine_About_Imitating_Others',
    ...
    '109': {
      ...
      audio: 'VO_Lumine_About_the_Vision_Hunt_Decree',
    ...
    '110': {
      ...
      audio: 'VO_Lumine_About_the_Resistance',
    ...
    '111': {
      ...
      audio: 'VO_Lumine_About_Kamuijima_Cannons',
    ...
    '114': {
      ...
      audio: 'VO_Lumine_About_Publishing_Novels',
    ...
    '115': {
      ...
      audio: 'VO_Lumine_About_Kaedehara_Kazuha',
    ...
    '116': {
      ...
      audio: 'VO_Lumine_About_Kamisato_Ayaka',
    ...
    '117': {
      ...
      audio: 'VO_Lumine_About_Imitating_Ayaka',
    ...
    '118': {
      ...
      audio: 'VO_Lumine_About_Festival_Traditions',
    ...
    '121': {
      ...
      audio: 'VO_Lumine_About_Onikabuto',
    ...
    '122': {
      ...
      audio: 'VO_Lumine_About_Naku_Weed',
    ...
    '123': {
      ...
      audio: 'VO_Lumine_About_Naku_Weed_and_Storms',
    ...
    '124': {
      ...
      audio: 'VO_Lumine_About_Sakura_Blooms',
    ...
    '125': {
      ...
      audio: 'VO_Lumine_About_Lavender_Melons',
    ...
    '127': {
      ...
      audio: 'VO_Lumine_About_Hot_Springs',
    ...
    '131': {
      ...
      audio: 'VO_Lumine_About_Tanuki_and_Their_Illusions',
    ...
    '134': {
      ...
      audio: 'VO_Lumine_About_Bantan_Sango_Detective_Agency',
    ...
    '135': {
      ...
      audio: 'VO_Lumine_About_Drawing_Fortune_Slips',
    ...
    '136': {
      ...
      audio: 'VO_Lumine_About_Musou_no_Hitotachi',
    ...
    '137': {
      ...
      audio: 'VO_Lumine_About_Sangonomiya_Kokomi',
    ...
    '138': {
      ...
      audio: 'VO_Lumine_About_Transience',
    ...
    '139': {
      ...
      audio: 'VO_Lumine_About_Shrine_Maidens',
    ...
    '140': {
      ...
      audio: 'VO_Lumine_About_the_Artist_Utamarou',
    ...
    '141': {
      ...
      audio: 'VO_Lumine_About_the_Teahouse_and_Its_Owner',
    ...
    '142': {
      ...
      audio: 'VO_Lumine_About_the_Sakoku_Decree',
    ...
    '145': {
      ...
      audio: 'VO_Lumine_About_The_Eremites',
    ...
    '147': {
      ...
      audio: 'VO_Lumine_About_the_Wall_of_Samiel',
    ...
    '148': {
      ...
      audio: 'VO_Lumine_About_Akasha_Terminals',
    ...
    '149': {
      ...
      audio: 'VO_Lumine_About_Aranara_Names',
    ...
    '150': {
      ...
      audio: 'VO_Lumine_About_Aranara_Cuisine',
    ...
    '162': {
      ...
      audio: 'VO_Lumine_About_the_Divine_Tree',
    ...
    '165': {
      ...
      audio: 'VO_Lumine_About_the_Alliance_of_the_Twenty-Nine_Ocean_Deys',
    ...
    '168': {
      ...
      audio: 'VO_Lumine_About_Aranara_Tongue_Twisters',
    ...
    '169': {
      ...
      audio: 'VO_Lumine_About_the_Prophesied_Crisis',
    ...
    '171': {
      ...
      audio: 'VO_Lumine_About_Patented_Flying_Technology',
    ...
    '172': {
      ...
      audio: 'VO_Lumine_About_the_Dark_Side_of_Publishing',
    ...
    '173': {
      ...
      audio: 'VO_Lumine_About_Armchair_Detectives',
    ...
    '174': {
      ...
      audio: 'VO_Lumine_About_the_Mysterious_Treasure_of_the_Fontaine_Research_Institute',
    ...
    '175': {
      ...
      audio: 'VO_Lumine_About_the_Big_No-No_of_Detective_Novels',
    ...
    '176': {
      ...
      audio: 'VO_Lumine_About_Claiming_Self-Defense',
    ...
    '179': {
      ...
      audio: 'VO_Lumine_About_Trials_and_Shows',
    ...
    '181': {
      ...
      audio: 'VO_Lumine_About_Gardemeks',
    ...
    '184': {
      ...
      audio: 'VO_Lumine_About_Fixing_Malfunctions',
    ...
    '185': {
      ...
      audio: 'VO_Lumine_About_the_Fortress_of_Meropide',
    ...
    '186': {
      ...
      audio: 'VO_Lumine_About_Supermeka',
    ...
    '189': {
      ...
      audio: 'VO_Lumine_About_Clockwork_Meka',
    ...
    '190': {
      ...
      audio: 'VO_Lumine_About_Fountains',
    ...
    '193': {
      ...
      audio: 'VO_Lumine_About_the_Palais_Mermonia',
    ...
    '195': {
      ...
      audio: 'VO_Lumine_About_the_Scions_of_the_Canopy',
    ...
    '196': {
      ...
      audio: 'VO_Lumine_About_the_Hot_Springs_of_Natlan',
    ...
    '197': {
      ...
      audio: 'VO_Lumine_About_the_Collective_of_Plenty',
    ...
    '198': {
      ...
      audio: 'VO_Lumine_About_Woven_Goods',
    ...
    '199': {
      ...
      audio: 'VO_Lumine_About_the_Collective_of_Plenty_and_the_Flower-Feather_Clan',
    ...
    '200': {
      ...
      audio: 'VO_Lumine_About_Ways_to_Make_Friends_With_Saurians',
    ...
    '201': {
      ...
      audio: 'VO_Lumine_About_Archaeology',
    ...
    '202': {
      ...
      audio: 'VO_Lumine_About_Resolving_Conflicts',
    ...
    '203': {
      ...
      audio: 'VO_Lumine_About_Ways_to_Make_a_Fortune',
    ...
    '204': {
      ...
      audio: 'VO_Lumine_About_Saurian_Stylists',
    ...
    '205': {
      ...
      audio: 'VO_Lumine_About_Ancient_Names',
    ...
    '206': {
      ...
      audio: 'VO_Lumine_About_the_Stadium_of_the_Sacred_Flame',
    ...
    '208': {
      ...
      audio: 'VO_Lumine_About_Graffiti',
    ...
    '209': {
      ...
      audio: 'VO_Lumine_About_Saurian_Companions',
    ...
    '212': {
      ...
      audio: 'VO_Lumine_About_Living_With_Saurians',
    ...
    '213': {
      ...
      audio: 'VO_Lumine_About_the_Volcano',
    ...
    '214': {
      ...
      audio: '71106',
      text: "#___: There once was a great knight who was cursed to spend the daylight hours looking like a shabby old drunkard.\\n___: Only in the dead of night would he return to his true form: a mature, brave, and self-respecting knight.\\n___: Is there a way to lift the curse?\\n___: Only if someone is willing to show genuine, heartfelt respect to the knight.\\n___: Alright, I can do that. Let the curse be lifted!\\n___: Ta-da! The curse has been lifted. Now, Grand Master Varka can choose for himself whether to be an old drunk or a respected knight.\\n___: And then he said, \"I'm sorry, but I've been a shabby old drunk all along.\" So now he's a shabby old drunk both day and night.\\n___: Wait, that's terrible!\\n___: There's a different version of the story in Natlan that goes like this: There once was a young girl cursed to become a snobby, stuck-up old lady during the day, only turning back into an innocent girl during the night.\\n___: And, um... the only way to lift the curse was, uhh... having conversations about topics she liked.\\n___: Well, I can already guess where this is going. If this was Madam Faruzan, then once the curse gets lifted, she'd probably say something like, \"Hmph, and what's wrong with being old? Do you have a problem with that, young lady?\"\\n___: Right! And if it was Citlali...\\n___: She'd get all anxious and pouty, and say, \"But... but I've been an innocent young girl all along...\"\\n___: ...There's no actual curse in either of these stories, is there?",
    ...
    '215': {
      ...
      audio: '71107',
      text: "#___: Five hundred... One thousand... One thousand two hundred...\\n___: What are you up to, ___?\\n___: Aaah! ...Sorry, you made ___ jump...\\n___: Hehe, ___ was counting her Mora. She's been saving up a lot lately! In a few days time, she'll finally have enough to go buy a surfboard from the People of the Springs!\\n___: Then, ___ can zip and zoom along the Spiritways, just like Mualani!\\n___: ...Spiritway surfing? You?\\n___: Well, yeah... You don't sound very happy about it, what's wrong?\\n___: I'm gonna miss you, that's all. I've enjoyed traveling with you... So many happy memories.\\n___: Wait, what!? Stop making it sound like ___ won't survive!\\n___: ___'s thought this through, y'know. Even if she falls off, it'll be fine — 'cause ___ can fly!\\n___: Mualani definitely has it harder in that sense... How does she even do it? The Spiritways get so steep and go so high, but she makes it look really easy.\\n___: I don't think Mualani finds it hard at all, actually. You can tell by the big smile she has on her face even while performing highly complex maneuvers.\\n___: Wait, so it's not hard, and ___'s just... useless? ...That's worse!",
      tips: 'Unlock the "People of the Springs" Teleport Waypoint in Natlan',
      tasks: null,
    },
    '216': {
      ...
      audio: '71108',
      text: "#___: So it turns out they use the Pilgrimage to select the Pyro Archon!\\n___: If ___ was allowed to compete, maybe even she'd have a shot at becoming the Pyro Archon.\\n___: Heh... That's the spirit, ___.\\n___: Hey now, don't you underestimate ___! After all the gods we've come face-to-face with, you'd better believe ___'s picked up a few of their signature moves!\\n___: ...Like what?\\n___: Like... A Buoyant Breeze, Slow-Cooked Bamboo Shoot Soup, Halvamazd, Pour la Justice...\\n___: Ohh... you mean their signature dishes.\\n___: Exactly! They should totally add a cook-off stage to the Pilgrimage! Once everything's settled down in Natlan, of course.\\n___: ___ can't wait to get a taste of the Pyro Archon's cooking!",
      tips: 'Complete "The Rainbow Destined to Burn"',
      tasks: [
        {
          type: 'finishMainQuest',
    ...
    '217': {
      ...
      audio: '71109',
      text: "#___: You know who we haven't seen in a while? Xilonen. Last time we saw her, she was lying down in a tree fast asleep.\\n___: And the time before that, she was sunbathing on the roof wearing sunglasses.\\n___: And the time before that, she was chilling in her home-made rocking chair, sipping fruit juice...\\n___: That's weird, how come our only memories of Xilonen are of her taking a break?\\n___: Hmm... It could be that those memories only stand out because they're so unusual. Maybe she's such a hard worker that she doesn't take breaks very often.\\n___: You think? Huh. Well, speaking of hard workers, ___'s been finding herself in that category quite a lot recently.\\n___: Like when we were chasing down that baby Tepetlisaur. ___ had to fly up pretty darn high to show you the way.\\n___: And also the time when we went Cacahuatl-picking, and helped that messenger from the Scions of the Canopy look for their package... Whew, if anything, ___'s been working TOO hard.\\n___: Hmph, ___'s gonna be doing a lot more slacking off during our commissions from now on. But secretly, so you won't notice!\\n___: You slack off all you need, ___. I'll make sure I don't notice.\\n___: Aww, that's so nice of you! In that case... whenever you're slacking off, ___ will make sure not to notice you, either!\\n___: Although actually... It might be easier if we just slacked off together...\\n___: Alright, new plan! We'll slack off at the same time, but without watching each other. C'mon, let's go, it's sunbathing time!",
    ...
    '218': {
      ...
      audio: '71110',
      text: '#___: ___ heard that the Frostmoon Scions worship the moon. So, what do you think they get up to during the daytime?\\n___: Uhh... just go about their normal lives, I guess?\\n___: No way, not if they\'re up all night worshiping! ___ bets they have a really unusual daily routine.\\n___: Unusual how?\\n___: Like, uh... When the sun comes up, they probably shapeshift into huge boulders and take a nice long nap.\\n___: When night falls, they wake back up again — and with a swish and a swoosh, they\'re back in human form! Then, they sneak away to start getting up to their secret, mysterious work...\\n___: So let me guess — the worst-case scenario for them is blowing through nap time and doing an all-day and all-nighter?\\n___: Yeah, exactly! See, you got it!\\n___: Yeah, I got it... You\'re getting mixed up between "Scion" and "Sayu" again.',
    ...
    '219': {
      ...
      audio: '71111',
      text: "#___: You know how some people from the Frostmoon Scions have antlers on their heads?\\n___: In ___'s view, that's a good sign. 'Cause if you think about it, over the years, everyone else we've met with horns or antlers has turned out to be a total legend!\\n___: Yeah, you're right... From the bull warrior of the Collective of Plenty to the Oni King of Hanamizaka, they all share one thing in common...\\n___: Which is?\\n___: You'd better get out of the way, before they... STAMPEEEEDE!\\n___: Whoooa, yeah! So, do you think that if Lauma ever got really mad, she'd...\\n___: ...Wait, no, that's ridiculous. ___ can't picture that happening, like... ever.\\n___: Me neither. But at the same time, I can't get the image out of my head...\\n___: ...Okay, well now ___'s imagining it too...\\n___: Ugh, what even is this conversation? Clearly, this is what happens when ___ goes hungry. We need snacks, pronto!",
    ...
    '220': {
      ...
      audio: '71112',
      text: "#___: Aino definitely lives up to her reputation as a whiz-kid mechanic. Everything she builds is so... creative.\\n___: She uses unlikely materials and slightly wacky designs, but all her inventions work even better than expected!\\n___: Which invention have you fallen in love with now, ___?\\n___: The cleaner bot's pretty cool!\\n___: We should get her to build one for us. It would be really handy to have in the Serenitea Pot!\\n___: Really, just the cleaner bot?\\n___: Hmm, you're right! We might as well make the most of Aino's talents. Let's get a dish-washer bot, a tidy-up bot, a gardener, and one to feed the pets...\\n___: While we're at it, it'd be great to get a chat bot, too. That way, Tubby will have someone to talk to when we're not around.\\n___: Good idea. Anything else to add?\\n___: Let's see... We could get a cooking bot? Something like the supreme cuisine machine, y'know? It'd be nice to have the option, but of course, there's no substitute for your home cooking, hehe.\\n___: Although, all these robots everywhere would take up a lot of space... Maybe it'd be better if we got Aino to combine them all into a single machine!\\n___: So basically, you want a multifunctional robot for domestic application... Better known as Ineffa.\\n___: Huh? Wait, you're right... Ineffa can do all of that stuff...\\n___: All that, and far more.\\n___: She even makes a pretty good travel guide...\\n___: Uhh... You're not seriously thinking of giving ___'s job to someone else, are you!?\\n___: No, no, no, that could never work! There's only one Ineffa, and she has to take care of Aino. We can't separate them!\\n___: Don't get ___ wrong, Ineffa's great, but, but... being a housekeeper in the Serenitea Pot would be too easy for her, don't you think? It'd be a real shame for all that talent to go to waste.\\n___: Okay, okay... ___ is the best guide I could ever hope for, and no one's ever gonna separate us.\\n___: Hmph. That's more like it.",
      tips: 'Complete "Elegy of Dust and Lamplight"',
      tasks: null,
    },
    '221': {
      ...
      audio: '71113',
      text: "#___: The boss of the Curatorium of Secrets, huh? Now there's a conundrum...\\n___: Yeah... Nefer does seem pretty mysterious.\\n___: That's true, but what ___ really meant was... Don't you think it's possible that the real boss is actually... Ashru the cat?\\n___: Huh? What are you basing that theory on?\\n___: Well, 'cause it's like how the boss of Komore Teahouse is Taroumaru!\\n___: And if so... Hehe, maybe Ashru has some treasure hidden behind the counter, too!\\n___: Ahh, treasure. So that's what this is about. But what does secret treasure have to do with whether Ashru is the boss or not?\\n___: Simple! The boss usually earns the most out of all the employees, so the boss's treasure is bound to be the most valuable of them all!\\n___: Heh, there's always \"value\" in ___'s insights.\\n___: But I'm afraid to say that all the available intel points to Nefer being the real boss. So why don't you just go ask her what treasure she has?\\n___: What? No way, not a chance! ...Ugh, never mind, then.\\n___: Hmm? Why the sudden change of heart?\\n___: Well, obviously 'cause...\\n___: ...___'s too scared.\\n___: ___ gets so nervous around her. When Nefer looks you in the eyes, it feels like she's gazing right into your soul... ___'s gut tells her that she's one of those people you should never, ever get on the wrong side of...\\n___: I'm with you there. We should play it safe... Let's go back to plan A, and see if we can figure out where Ashru's treasure is hidden.\\n___: Aha! So YOU were after Ashru's treasure this whole time, too!",
      tips: 'Complete "Elegy of Dust and Lamplight"',
      tasks: null,
    },
    '222': {
      ...
      audio: '71114',
      text: "#___: ___ heard that Nod-Krai is where the Treasure Hoarders were first founded. Hmph, it's just a fancy name for a bunch of common thieves!\\n___: If ___ ever found their headquarters, she'd bust in there and give 'em what for! Y'know, in the name of justice, and all that!\\n___: Oh yeah? And what kind of justice would crime-buster ___ be dishing out?\\n___: Hehe, poetic justice, of course! ___ read somewhere that that means giving the bad guys a taste of their own medicine.\\n___: So ___ would track down every bit of treasure they're hoarding at their base, and steal it all! See how THEY like having their treasure taken from them!\\n___: Hmm... Then lemme ask you this — if you stole all their treasure, wouldn't that just make you another treasure hoarder in their eyes?\\n___: Uh... Maybe? Yeah, kinda...\\n___: Oh dear... I'm sorry to say that makes you no better than a common thief, ___. And for the sake of justice, I would feel compelled to punish this heinous crime by seizing your secret stash of treasure myself! Hooray for ___, putting the world to rights once again!\\n___: Hey! That isn't justice, that's plain old justifying!",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
    '223': {
      ...
      audio: '71115',
      text: "#___: Did you know that the first group to conquer Nasha Town was the Conch Gang? Or so the story goes.\\n___: The Conch Gang? You mean, that gang where they're all kids?\\n___: That's right. In fact, they only accept children as members, and after you get to a certain age, they kick you out. That's their gang tradition — it's been that way from the very beginning.\\n___: Wait, so you're saying that a bunch of kids took over Nasha Town!? What a funny thought... They must've been some pretty tough kids! Did they have superpowers or something?\\n___: Umm... I don't think so. At least, the story I heard didn't mention anything about that.\\n___: Then how the heck did a bunch of kids conquer a whole town in Nod-Krai?\\n___: I guess they just hung out and played games in what's now the market square. There probably weren't any shops in Nasha Town back then.\\n___: That doesn't sound much like \"conquering\"...\\n___: Before long, the grown-ups took a liking to the place... Slowly but surely, the children's Elysium was engulfed by the adult world...\\n___: Couldn't they just... find somewhere else to play?\\n___: That's easier said than done... I mean, imagine if one day, you suddenly found that your favorite nap spot in the whole garden had been taken over by hilichurls.\\n___: Once a cozy patch of lawn, now a camp full of rowdy hilichurls who throw pebbles at you to keep you away... You'd never be able to nap in your favorite spot, ever again...\\n___: Nooo! That's terrible! ___ was there first! Stupid hilichurls... Oh, and stupid grown-ups!\\n___: So... what happened after that? Did the Conch Gang fight back?\\n___: I'm not too sure. It's possible that they tried, but... I suspect that when the kids in the gang grew up, they had to make a living somehow, so they ended up turning into the same adults that they once saw as their enemies.\\n___: Oh... Well that took a depressing turn...\\n___: To be honest, it's probably not a true story. The Conch Gang of today, on the other hand — they seem to be doing great. They have a lot of members and some pretty good benefits.\\n___: Ooh, benefits? Hehe, can ___ join?\\n___: Oh, I'm sure you'd have no problem getting in! And if you don't like it, I heard that you can leave at any time.\\n___: Not a \"homies for life\" type of gang, then...\\n___: You know, I think it would suit you.\\n___: Adults are so set in their ways, whereas children are lovable little people who are free to be themselves... just like you, ___.",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
    '224': {
      ...
      audio: '71116',
      text: "#___: I've got the latest issue of the Nasha Express here. Let's see what's in it...\\n___: Ooh, Nod-Krai has a newspaper too? Well, what does it say? Is it full of juicy stories like The Steambird?\\n___: Hehe, Nod-Krai's pretty chaotic compared to Fontaine. The news here must be crazy!\\n___: Hmm...\\n___: Don't worry, even if it's heavy going, ___ can handle it! ___ wouldn't be surprised if it's nothing but crime from cover to cover.\\n___: Oh...\\n___: ...Of course, if there's any super creepy, nightmare-fuel-type stories... maybe don't tell ___ those.\\n___: ...What is it? Why aren't you saying anything? It's not... it's not ALL super creepy nightmare fuel, is it!?\\n___: No, there's no nightmare fuel. It's not so much \"creepy\"... it's just plain weird.\\n___: For example: \"The Flagship is seeking a new bartender. Must have cocktail-mixing experience. Salary negotiable. Preference for candidates who are patient, hard of hearing, and good at taking notes.\"\\n___: \"Mimisbrunnr Books is holding a clearance sale. Many old titles for sale by the kilogram at bargain prices. Browse first at no charge. Please note: Established authors, budding authors, or any other type of authors should not use this as an opportunity to advertise your work, or you may find your stock being sold off dirt cheap by the kilogram too.\"\\n___: \"New flower seeds now available at Vesnici Proleca Greenhouse. Each purchase comes with a full suite of essentials to keep your plant in tip-top condition: 1 can of engine oil, 1 bag of rust, and 1 pair of cut-resistant gloves. Limited stock available on a first-come, first-served basis.\"\\n___: What kind of flower needs oil and rust!?\\n___: Aren't newspapers supposed to report the news? This just seems like a classifieds section gone mad.\\n___: Pretty fun though, right? A little window into daily life in Nod-Krai.\\n___: All that says to ___ is that the people here live very strange and very confusing lives...\\n___: Well... What is life if not the thread between events that offers some semblance of order amidst chaos? The through-line that we cling to in an effort to traverse the maze that is the cosmos?\\n___: Honestly, whatever you just said went completely over ___'s head. Let's stick with the newspaper for now. Any other interesting ads?\\n___: Umm... Ah, here we go! There's some good news and some bad news — which do you want to hear first?\\n___: Uhh... The good news?\\n___: \"Seeking game-testers for a paid position. Flat rate per session. Perks include free lunch, free dinner, and a small gift at the end of each session.\"\\n___: That sounds pretty cool! Hehe, we should definitely check that out! Let's apply quick before someone else gets it!\\n___: First things first, ___ — the bad news. Which also happens to be related to the game-tester position.\\n___: What is it? *sigh* Did they fill all the positions already?\\n___: The ad was posted by a researcher from the Fontaine Research Institute by the name of... Liouba.\\n___: Okay, time to throw that paper away, ___. Let's head to Vesnici Proleca Greenhouse and check out this flower that you're apparently supposed to oil instead of water.",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
    '225': {
      ...
      audio: '71117',
      text: "#___: Nod-Krai seems like a pretty complicated place. There are tons of people from all over Teyvat here.\\n___: We've seen people from Liyue, Fontaine, Sumeru, Inazuma... Even Natlan!\\n___: Wait... Hey, how come we've hardly seen any merchants from Mondstadt here? That doesn't seem right.\\n___: Mondstadt's the wine capital of the world, right? You'd think someone would be making a killing off of that out here.\\n___: Maybe Mondstadt wine isn't really designed for exporting. Most of it's brewed and enjoyed locally. It might lose its flavor when transported long distances.\\n___: And even if someone managed to solve that problem, the cost of shipping it all this way would mean they'd have to increase the price, which would make it harder to sell... Maybe it's simply too difficult to turn a profit.\\n___: You think? Hehe... ___'s theory was that Mondstadters drink so much, there's none left to export.\\n___: Um... That could be part of the reason, for sure. They can't get enough of their wine, can they?\\n___: Hey, the next time we go back to Mondstadt, we should bring some Nod-Krai liquor with us.\\n___: Yeah... the strongest one, and then get Charles to trick Kaeya into drinking it by masking the flavor with some other drink.\\n___: While we're at it, we should get gifts for other people too. A ragdoll for Klee, and how about a little robot for Sucrose? Might come in handy with her research!\\n___: Oh yeah — and remember those red goggles we saw that time? Maybe a pair of those for Amber?\\n___: You know what — let's go souvenir shopping right now! There's a bunch of other cool gifts ___'s thinking of getting too... She won't spend all our Mora, promise!",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
    '226': {
      ...
      audio: '71118',
      text: "#___: Let me tell you a story about one of the craziest con games in Nod-Krai's history.\\n___: There once was a thief and a conman who heard that a traveling merchant had just arrived in town. This merchant was said to be extremely wealthy and a big spender — meaning he'd brought a huge stash of valuables and Mora with him. And so, the thief and the conman decided to team up to try and steal the merchant's wealth.\\n___: Uh-oh. How far did they get?\\n___: After working to gain the merchant's trust, the conman invited the merchant out to a big dinner party one evening. The plan was to get him away from his shop for long enough for the thief to break in and steal all the treasure... And it went off without a hitch.\\n___: ...Aw, poor merchant.\\n___: But the story doesn't end there. The con artist wanted all the loot for himself. He turned on the thief, threatened him into handing everything over, and then sold him out. The thief took the fall and wound up in jail.\\n___: Huh. Behind every crook is an even crooked-er crook. So in the end, the conman conned both the merchant and the thief... and by the sounds of it, he got away with it too? Ugh...\\n___: Now, your typical crime story would probably end there. But not this one...\\n___: There's more?\\n___: After the conman finally got his hands on the treasure, he discovered that it was all fake! He started to panic... and then, the merchant comes bursting through the door, demanding that his assets be returned.\\n___: Wait, but they were fake, right? Why did he want them back?\\n___: Obviously, the merchant claimed that everything stolen by the thief was real. So in the end, the conman was forced to return genuine treasure, and not the fake stuff.\\n___: Ohh... So the merchant was the real conman in that story! Heh, so much for \"poor merchant.\"\\n___: True, but if the conman and the thief hadn't given in to their crooked ways, the merchant would never have done anything to them. So the moral of this story is:\\n___: If you're gonna play the con game, you gotta go big or go home!\\n___: ...Actually, it's \"don't give in to your crooked ways\"...",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
    '227': {
      ...
      audio: '71119',
      text: "#___: So, you know how Ineffa's a robot?\\n___: ___'s been wondering... Do you think she has an on-off switch?\\n___: I've never seen it, but... probably, I guess?\\n___: Wow... ___'s sooo jealous.\\n___: Why?\\n___: Well, think about it. Ineffa goes to wake Aino up in the morning, but Aino wants to sleep in. All Aino has to do is...\\n___: ...Flip Ineffa's off switch so she powers down?\\n___: Exactly!\\n___: ___, ___, ___'s bestest buddy in the whole wide world! Can you get Aino to make you an on-off switch too?\\n___: Sure!\\n___: Huh? You're just gonna say yes without even asking why?\\n___: I think I already know why. You want to flip my off switch when you feel like sleeping in!\\n___: What!? You saw right through ___'s plan...\\n___: The thing is, after all the spare parts I've thrown her way, I've pretty much got Aino in my pocket...\\n___: So although it would look like an off switch, it would actually activate my emergency mode. And then I'd... suddenly spring into action and start tickling you mercilessly! Protest all you want, ___ — the tickling cannot be stopped!\\n___: No, noooo! We're not getting you an on-off switch, okay? Happy now?",
      tips: 'Complete "Elegy of Dust and Lamplight"',
      tasks: null,
    },
    '228': {
      ...
      audio: '71120',
      text: "#___: Aino's inventions are a real bargain!\\n___: That's because she builds them from scrap, which has no value to anyone else.\\n___: ___ was thinking, maybe we should get Aino to build us a hoverboard... 'cause then, you'd be able to fly just like ___!\\n___: It would make the rest of your journey way easier. We could just fly the whole way!\\n___: Wow, what an amazing idea, ___! So, what's your budget?\\n___: Uh... ___ only has 500 Mora left after last week... B—But Aino might still be able to find a way, right?\\n___: Hmm... That's a pretty tight budget. At this rate, our hoverboard might have to be powered by a potato battery...\\n___: Mmm... Potato-powered aviation... *drools*\\n___: ...Wait, hold up, a potato battery? Is that a real thing?",
      tips: 'Complete "Elegy of Dust and Lamplight"',
      tasks: null,
    },
    '229': {
      ...
      audio: '71121',
      text: "#___: Flins gives the best compliments!\\n___: ___ could listen to his flattery all day... Ah, that would be the best day ever!\\n___: Very true. You're so attentive, ___, and you always see the best in people. That's why you have a knack for identifying people's finer qualities.\\n___: Hee-hee, too right! Attentive ___ always sees the best in people!\\n___: Not to mention the courage and dedication you've shown in keeping me company all this time. You always see things through, even when it's hard work, and you've never abandoned me even when mortal danger is staring us in the face.\\n___: Aw, shucks, you really mean that?\\n___: On top of all that, you're as smart as you are sweet. The idea of traveling without ___ by my side is too terrible to even contemplate.\\n___: C'mon, ___, knock it off, y—you're making ___ blush...\\n___: Okay, three compliments in and you're as red as a tomato. Imagine what a full day of compliments from Flins would do to you...\\n___: Waaah! Whew, thanks, but no thanks!",
      tips: 'Complete "Elegy of Dust and Lamplight"',
      tasks: null,
    },
    '230': {
      ...
      audio: '71122',
      text: "#___: Those Sniffer Moles have a really keen sense of smell, huh? They're experts when it comes to foraging for berries.\\n___: We should get some as pets! Hehe, then we could have all the Lakkaberries and Midsommar Berries we wanted!\\n___: And then you could make Krumkakes and Midsommar Torte for ___ every day!\\n___: It's a nice idea, but Sniffer Moles are wild animals. Would they really make good pets?\\n___: Hehe, don't you worry about that, ___'s got it all figured out!\\n___: Back in Sumeru, ___ read this book from the Amurta Darshan which said that if you raise an animal from a young enough age, they'll treat you like family.\\n___: So let's go find some young whipper-snapper Sniffer Moles and raise 'em right!\\n___: Hmm... In that case, it'd probably be a few months before they were old enough to fend for themselves.\\n___: Obviously, we'd need to feed them properly during that time... and as we know, their diet is mostly Lakkaberries and Midsommar Berries.\\n___: So by the time they're all grown up, ___'s stash of Lakkaberry Krumkakes and Midsommar Torte will be completely decimated.\\n___: Waaah! Noooo! Ugh, why did you have to turn this into a horror story?",
      tips: "Unlock the Statue of the New Moon on Nod Krai's Lempo Isle",
      tasks: null,
    },
  },
