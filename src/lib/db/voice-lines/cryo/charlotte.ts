export const charlotteVL = {
  quotes: {
    '0': {
      title: 'Hello',
      audio: 'VO_Charlotte_Hello',
      text: "Hi there! I'm ___, a journalist with The Steambird. It's a pleasure to meet you. If you've got time, would you be open to doing an exclusive interview? My journalistic instincts tell me that there's a treasure trove of news in you just bursting to get out!",
      tips: '',
      tasks: null,
    },
    '1': {
      title: 'Chat: News',
      audio: 'VO_Charlotte_Chat_-_News',
    ...
    '2': {
      ...
      audio: 'VO_Charlotte_Chat_-_Journalists',
    ...
    '3': {
      ...
      audio: 'VO_Charlotte_Chat_-_The_Steambird',
    ...
    '4': {
      title: 'When It Rains',
      audio: 'VO_Charlotte_When_It_Rains',
    ...
    '5': {
      ...
      audio: 'VO_Charlotte_When_Thunder_Strikes',
    ...
    '6': {
      title: 'When It Snows',
      audio: 'VO_Charlotte_When_It_Snows',
    ...
    '7': {
      ...
      audio: 'VO_Charlotte_When_the_Sun_Is_Out',
    ...
    '8': {
      title: 'Good Morning',
      audio: 'VO_Charlotte_Good_Morning',
    ...
    '9': {
      ...
      audio: 'VO_Charlotte_Good_Afternoon',
    ...
    '10': {
      title: 'Good Evening',
      audio: 'VO_Charlotte_Good_Evening',
    ...
    '12': {
      title: 'About ___: Career',
      audio: 'VO_Charlotte_About_Charlotte_-_Career',
    ...
    '13': {
      title: 'About ___: Photography',
      audio: 'VO_Charlotte_About_Charlotte_-_Photography',
    ...
    '14': {
      ...
      audio: 'VO_Charlotte_About_Us_-_Exclusive_Feature',
    ...
    '15': {
      ...
      audio: 'VO_Charlotte_About_Us_-_Headliners',
    ...
    '16': {
      ...
      audio: 'VO_Charlotte_About_the_Vision',
    ...
    '17': {
      ...
      audio: 'VO_Charlotte_Something_to_Share',
    ...
    '18': {
      ...
      audio: 'VO_Charlotte_Interesting_Things',
    ...
    '19': {
      title: 'About Navia',
      audio: 'VO_Charlotte_About_Navia',
    ...
    '20': {
      title: 'About Lyney',
      audio: 'VO_Charlotte_About_Lyney',
    ...
    '21': {
      title: 'About Lynette',
      audio: 'VO_Charlotte_About_Lynette',
    ...
    '22': {
      ...
      audio: 'VO_Charlotte_About_Clorinde',
    ...
    '23': {
      ...
      audio: 'VO_Charlotte_About_Wriothesley',
    ...
    '24': {
      title: 'About Emilie',
      audio: 'VO_Charlotte_About_Emilie',
    ...
    '25': {
      title: 'About Chiori',
      audio: 'VO_Charlotte_About_Chiori',
    ...
    '26': {
      ...
      audio: 'VO_Charlotte_About_Freminet',
    ...
    '27': {
      ...
      audio: 'VO_Charlotte_About_Neuvillette',
    ...
    '28': {
      title: 'About Furina',
      audio: 'VO_Charlotte_About_Furina',
    ...
    '30': {
      ...
      audio: 'VO_Charlotte_More_About_Charlotte_-_01',
    ...
    '31': {
      ...
      audio: 'VO_Charlotte_More_About_Charlotte_-_02',
    ...
    '32': {
      ...
      audio: 'VO_Charlotte_More_About_Charlotte_-_03',
    ...
    '33': {
      ...
      audio: 'VO_Charlotte_More_About_Charlotte_-_04',
    ...
    '34': {
      ...
      audio: 'VO_Charlotte_More_About_Charlotte_-_05',
    ...
    '37': {
      title: 'Favorite Food',
      audio: 'VO_Charlotte_Favorite_Food',
    ...
    '38': {
      ...
      audio: 'VO_Charlotte_Least_Favorite_Food',
    ...
    '39': {
      ...
      audio: 'VO_Charlotte_Receiving_a_Gift_-_01',
    ...
    '40': {
      ...
      audio: 'VO_Charlotte_Receiving_a_Gift_-_02',
    ...
    '41': {
      ...
      audio: 'VO_Charlotte_Receiving_a_Gift_-_03',
    ...
    '43': {
      ...
      audio: 'VO_Charlotte_Feelings_About_Ascension_-_01',
    ...
    '44': {
      ...
      audio: 'VO_Charlotte_Feelings_About_Ascension_-_02',
    ...
    '45': {
      ...
      audio: 'VO_Charlotte_Feelings_About_Ascension_-_03',
    ...
    '46': {
      ...
      audio: 'VO_Charlotte_Feelings_About_Ascension_-_04',
    ...
    '47': {
      ...
      audio: 'VO_Charlotte_Elemental_Skill_1_01',
      text: 'Say cheese!',
      tips: '',
      tasks: null,
    },
    '48': {
      ...
      audio: 'VO_Charlotte_Elemental_Skill_1_02',
      text: 'Smile!',
      tips: '',
      tasks: null,
    },
    '49': {
      ...
      audio: 'VO_Charlotte_Elemental_Skill_1_03',
      text: 'Hold that pose!',
      tips: '',
      tasks: null,
    },
    '50': {
      ...
      audio: 'VO_Charlotte_Elemental_Burst_01',
      text: 'Truth bomb!',
      tips: '',
      tasks: null,
    },
    '51': {
      ...
      audio: 'VO_Charlotte_Elemental_Burst_02',
      text: 'Breaking news!',
      tips: '',
      tasks: null,
    },
    '52': {
      ...
      audio: 'VO_Charlotte_Elemental_Burst_03',
    ...
    '53': {
      ...
      audio: 'VO_Charlotte_Opening_Treasure_Chest_01',
    ...
    '54': {
      ...
      audio: 'VO_Charlotte_Opening_Treasure_Chest_02',
    ...
    '55': {
      ...
      audio: 'VO_Charlotte_Opening_Treasure_Chest_03',
    ...
    '59': {
      ...
      audio: 'VO_Charlotte_Ally_at_Low_HP_01',
      text: 'Careful!',
      tips: '',
      tasks: null,
    },
    '60': {
      ...
      audio: 'VO_Charlotte_Ally_at_Low_HP_02',
    ...
    '64': {
      ...
      audio: 'VO_Charlotte_Light_Hit_Taken_01',
      text: 'How rude!',
      tips: '',
      tasks: null,
    },
    '65': {
      ...
      audio: 'VO_Charlotte_Heavy_Hit_Taken_01',
      text: 'My Kamera!',
      tips: '',
      tasks: null,
    },
    '66': {
      ...
      audio: 'VO_Charlotte_Joining_Party_01',
    ...
    '67': {
      ...
      audio: 'VO_Charlotte_Joining_Party_02',
    ...
    '68': {
      ...
      audio: 'VO_Charlotte_Joining_Party_03',
  ...
  story: {
    ...
    '3': {
      ...
      title2: null,
      text: 'After ___\'s extraordinary photography skills had made her famous, she began receiving frequent visits from manuscript writers, magazine editors, news clipping collectors, and her father\'s reporter colleagues. Even Euphrasie, the Editor-in-Chief of The Steambird, was amongst them.\\nEuphrasie was straightforward about her intent. She hoped that ___ would agree to become a "special correspondent" — someone who would conduct interviews and write articles in addition to taking photographs.\\n...However, her father, despite his usual mild temperament, was strongly against it. He did not wish for his daughter to associate with those kinds of people, either full of ulterior motives or hypocrites.\\n"Nature is fierce, but it is honest. Storms don\'t loose their fury without reason, nor do beasts bare their fangs without cause."\\n"But people lie — they always do. A Kamera can only capture their faces, but the lens cannot target their hearts."\\nHe would respect ___\'s decision, of course, but he preferred that ___ live a simpler, happier life, without sinking into the morass of humanity.\\nTo ___, this world was a treasure trove, and pictures her treasure maps.\\nBut for the first time, she came to realize that this trove still harbored undiscovered "truths."\\nThese truths were not themselves treasures, but were more akin to a procession of dark memories. Intentionally hidden, discarded, disguised, and then abandoned, with those having done so wishing that they would never be discovered, and that all events connected to them would simply end right there.\\n___ knew that she could find them. She could dig up these truths, like digging tulip bulbs in a garden, like leading hermit crabs out of their shells, like finding pinecones hidden by squirrels.\\n...But she also felt like a bird glimpsing an onrushing flash flood, a cave rat foreseeing an earthquake, or a fish sensing a coming tsunami.\\nWith great ability comes great responsibility.\\nOne with the talent for uncovering "truth" was also responsible for bringing the "truth" to light.\\nThe only question was, did she have the courage to do so?\\nHer parents responded with silence, for they knew that their daughter had already made her choice. ___ was old enough, and all birds are destined to spread their wings and leave the nest someday.\\nThe next morning, Euphrasie went to work as usual, and there, waiting for her at the entrance to The Steambird, she saw ___, ready with her Kamera and notepad.\\n"Welcome to The Steambird, ___."\\nEuphrasie extended a hand.\\n"I believe the next La Verite Prize is yours to win."',
      text2: null,
      tips: 'Unlocks at Friendship Lv. 4',
    },
    '4': {
    ...
    '5': {
      ...
      title2: null,
      text: '"Prestige Prize Proved Perniciously Partial — The Real La Verite."\\nThis was the headline on the day the award was to be announced.\\nIn it, ___ detailed the various monetary dealings that the long-serving members of the La Verite Award selection committee had engaged in over the previous decade, various inequities in their judgments, and provided an exhaustive list of reporters and reports who had been done dirty in the process.\\nHer report caused an uproar in the Court of Fontaine, with countless reporters surging to the committee offices — ___, of course, among them.\\nAmidst a broadside of shutter clicks, ___ unleashed a barrage of meticulously-prepared questions from a thick notebook at the dumbstruck committee members, one after another. Red and shame-faced, the gentlemen flapped their clumsy lips as best they could, only to produce explications akin to porous cheese. In the end, they had to declare the questions out of order and in violation of normal procedure, before fleeing right before the gathered reporters\' eyes.\\n___\'s "report" had barely begun, though.\\nShe continued publishing articles concerning the La Verite Award in The Steambird, even directing her pen against certain figures in the newspaper itself who had been connected to the La Verite selection committee, laying out the manner in which they had recommended reporters with whom they shared beneficial arrangements for awards, and how those reporters had returned the favors...\\n___\'s articles swept through the Fontainian media world like a tidal wave, and in response to public outcry, the Maison Gardiennage declared an official inquiry into the Award, suspending its activities and investigating all suspicious awardees.\\n___, for her part, temporarily lived inside The Steambird\'s offices, with all prospective visitors "wanting a word with her" being turned away by Euphrasie with extreme prejudice. It reached the point where the Maison Gardiennage even dispatched a guard detail to the newspaper\'s office entrance.\\nWith her own hand ___ had lifted a huge stone that none had wanted to peek under, and the creepy crawlies that had lurked in its cracks and crevices now had to face the searing sunlight of the "truth."\\nThe Maison Gardiennage\'s investigation concluded three months later. Judges who had given unjust judgment, contestants who had contended to win glory undeserved, and editors who sought to edify themselves all received their just deserts.\\nThe La Verite Award selection committee was also wholly reorganized, now under various forms of new oversight. Once this was complete, the first thing they did was to give ___ the now utterly discredited award.\\nOf course, the trophy was but dead dross to her.\\nThe real honor she had received was that the "truth" she had revealed in her report — and the ones that followed in its wake, of course — now shone in the sun.',
      text2: null,
      tips: 'Unlocks at Friendship Lv. 6',
    },
    '6': {
